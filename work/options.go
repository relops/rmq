...
type Options struct {
	...
	Persistent        bool     `short:"T" long:"persistent" description:"Use persistent messaging"`
	NoDeclare         bool     `short:"n" long:"no-declare" description:"If set, then don't attempt to declare the queue or bind it"`
	...
	GlobalPrefetch    bool     `short:"G" long:"global-prefetch" description:"Whether to share the prefetch limit accross all consumers of a channel"`
	...
	Delete            bool     `short:"D" long:"delete" description:"If set, it will remove the object specified by the -q or -a argument"`
	Info              bool     `short:"I" long:"info" description:"If set, print basic server info (requires management API to be installed on the server)"`
	...
	Renew             bool     `short:"r" long:"renew" description:"Automatically resubscribe when the server cancels a subscription (used for mirrored queues)"`
	...
	Entropy           bool     `short:"e" long:"entropy" description:"Display message level entropy information"`
